...
import { getAllProducts, getAllPro } from '../features/products/productSlice';
    ...
    <>
      ...
      <div className='store-wrapper home-wrapper-2 py-5'>
        <div className='container-fluid'>
            <div className='row'>
                <div className='col-12 d-flex flex-column justify-content-center align-items-center' style={{ marginBottom:'20px'}}>
                  <h1>ALL PRODUCTS</h1>
                  <div className='col-6'>
                    <Marquee speed={10}>
                    {
                      brandState?.map((item, index)=>{
                        return(
                          <div className='d-flex flex-column' onClick={()=> setBrand(item?.title)} key={index} style={{ backgroundColor: 'white', margin:'10px 10px', padding: '20px 20px', width:'200px'}}>
                            <img src={item?.images[0]?.url}  width={150} height={80}/>
                ...
                <div className='col-9'>
                  <div className='filter-sort-grid mb-4'>
                    <div className='d-flex justify-content-between align-items-center'>
                      <div className='d-flex align-items-center gap-10'>
                        <p className='mb-0 d-block' style={{ width: "110px", fontWeight:'bold',}}>Sort By:</p>
                        <select 
                          name='' 
                          ...
                          <option value="-price">Reduce</option>
                          <option value="createAt">New</option>
                          <option value="-createAt">Old</option>
                        </select>
                      </div>
